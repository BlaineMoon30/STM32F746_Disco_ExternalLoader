...
#ifndef __INC_N25Q128_H_
#define __INC_N25Q128_H_
...
extern HAL_StatusTypeDef N25Q128A_Init(void);
extern uint8_t N25Q128A_QSPI_Read(uint8_t* pData, uint32_t ReadAddr, uint32_t Size);
extern uint8_t N25Q128A_QSPI_Write(uint8_t* pData, uint32_t WriteAddr, uint32_t Size);
extern uint8_t N25Q128A_QSPI_Erase_Block(uint32_t BlockAddress);
extern uint8_t N25Q128A_QSPI_GetStatus(void);
extern uint8_t N25Q128A_QSPI_GetInfo(QSPI_Info* pInfo);
extern uint8_t N25Q128A_QSPI_EnableMemoryMappedMode(void);
