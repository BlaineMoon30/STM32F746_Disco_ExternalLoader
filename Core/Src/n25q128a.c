...
/**
  ...
  * @retval None
  */
HAL_StatusTypeDef N25Q128A_Init(void)
{
  /* QSPI memory reset */
...
/**
  ...
  */
uint8_t N25Q128A_QSPI_Read(uint8_t* pData, uint32_t ReadAddr, uint32_t Size)
{
  QSPI_CommandTypeDef s_command;
...
/**
  ...
  * @retval QSPI memory status
  */
uint8_t N25Q128A_QSPI_Write(uint8_t* pData, uint32_t WriteAddr, uint32_t Size)
{
  QSPI_CommandTypeDef s_command;
...
/**
  ...
  * @retval QSPI memory status
  */
uint8_t N25Q128A_QSPI_Erase_Block(uint32_t BlockAddress)
{
  QSPI_CommandTypeDef s_command;
...
/**
  ...
  * @retval QSPI memory status
  */
uint8_t N25Q128A_QSPI_Erase_Chip(void)
{
  QSPI_CommandTypeDef s_command;
...
/**
  ...
  * @retval QSPI memory status
  */
uint8_t N25Q128A_QSPI_GetStatus(void)
{
  QSPI_CommandTypeDef s_command;
  uint8_t reg;
...
/**
  ...
  * @retval QSPI memory status
  */
uint8_t N25Q128A_QSPI_GetInfo(QSPI_Info* pInfo)
{
...
/**
  ...
  * @retval QSPI memory status
  */
uint8_t N25Q128A_QSPI_EnableMemoryMappedMode(void)
{
  QSPI_CommandTypeDef      s_command;
